        ...
        <div className="bg-white rounded-2xl shadow-xl w-full max-w-md" onClick={(e) => e.stopPropagation()}>
          ...
          <div className="p-6">
            ...
            <div className="flex items-center border rounded-lg p-2 bg-gray-50">
              ...
              <button onClick={copyUrl} className="bg-indigo-500 text-white px-3 py-1 rounded text-sm font-semibold hover:bg-indigo-600 transition-colors">복사</button>
            </div>
          </div>
        </div>
      </div>
...
export default function MainPage({
  ...
  useEffect(() => {
    ...
    setTotalElements(listData.totalElements ?? mapped.length);
    setLoading(false);
  }, [listData]);
  ...
  const categoryDisplayNames = { 전체: '전체', POLITICS: '정치', ECONOMY: '경제', SOCIETY: '사회', LIFE: '생활', INTERNATIONAL: '세계', IT_SCIENCE: 'IT/과학', VEHICLE: '자동차/교통', TRAVEL_FOOD: '여행/음식', ART: '예술' };
          ...
          <div className="lg:col-span-3">
                ...
                <div className="w-full overflow-x-auto flex space-x-3 pb-2">
                  {categories.map((category, index) => (
                      <Button
                          ...
                          className={`whitespace-nowrap hover-lift text-base px-4 py-2 korean-text ${isLoaded ? 'animate-slide-in' : 'opacity-0'}`}
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    {popularNewsLoading && !initialTrending ? (
                        ...
                        <>
                          ...
                          <div className="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent p-4 md:p-6 flex flex-col justify-end text-white">
                            ...
                            <h2 className="text-lg lg:text-xl font-bold mb-2 line-clamp-2 korean-text">{popularNews.title}</h2>
                            ...
                            <div className="flex items-center justify-between text-xs text-gray-300">
                              ...
                              <div className="flex items-center space-x-2">
                                ...
                                <button onClick={(e) => handleShareClick(e, popularNews)} className="p-2 hover:bg-gray-100/20 rounded-full transition-all duration-200">
                        ...
                        <div className="w-full h-full flex items-center justify-center text-gray-500">인기 뉴스를 불러올 수 없습니다.</div>
                    )}
                  </Card>
                </Link>
              </div>
              ...
              <div className="lg:col-span-1 flex flex-col gap-6" style={{ height: '780px' }}>
                {(relatedNews.length > 0 ? relatedNews : filteredNewsItems.slice(0, 2)).map((item, index) => (
                    <Link
                        ...
                        <div className="flex flex-col justify-between flex-1 px-4 py-3 min-h-0">
                          <div className="flex-1 flex flex-col min-h-0">
                            <div className="flex justify-between items-center mb-2">
                              <Badge className="bg-blue-600 text-white text-xs px-3 py-1 rounded-full shadow">{categoryDisplayNames[item.category] || item.category}</Badge>
                              <span className="text-xs text-gray-500 flex items-center flex-shrink-0 ml-2">
                                <Clock className="h-3 w-3 mr-1" />
                                {new Date(item.publishedAt).toLocaleDateString('ko-KR', { month: 'short', day: 'numeric', hour: '2-digit', minute: '2-digit' })}
                              </span>
                            </div>
                          ...
                          <div className="flex items-center justify-between pt-3 mt-2">
                            ...
                            <div className="flex items-center space-x-1 flex-shrink-0">
                              ...
                              <button onClick={(e) => handleShareClick(e, item)} className="p-2 hover:bg-gray-100 rounded-full transition-all duration-200">
                      ...
                      <div className="flex flex-col justify-between flex-1 px-4 py-3 min-h-0">
                        <div className="flex-1 flex flex-col min-h-0">
                          <div className="flex justify-between items-center mb-2">
                            ...
                            <span className="text-xs text-gray-500 flex items-center flex-shrink-0 ml-2">
                              <Clock className="h-3 w-3 mr-1" />
                              {new Date(news.publishedAt).toLocaleDateString('ko-KR', { month: 'short', day: 'numeric', hour: '2-digit', minute: '2-digit' })}
                            </span>
                          </div>
                          <div className="flex-1 mt-1 pb-3 border-b border-gray-100">
                        ...
                        <div className="flex items-center justify-between pt-3 mt-2">
                          ...
                          <div className="flex items-center space-x-1 flex-shrink-0">
                            ...
                            <button onClick={(e) => handleShareClick(e, news)} className="p-2 hover:bg-gray-100 rounded-full transition-all duration-200">
                              <Share className="w-4 h-4 text-gray-600" />
                            </button>
                          </div>
                        </div>
