      ...
      <div className="h-9 overflow-hidden">
        ...
        >
          <div className="flex items-center gap-2">
            <Badge variant="secondary" className="bg-indigo-100 text-indigo-700 text-xs px-2 py-0.5 rounded-md">
              {cur.rank}
            </Badge>
            <span className="text-sm text-gray-800">{cur.keyword}</span>
            <DiffIcon diff={cur.diff} />
          </div>
          <Badge variant="secondary" className="text-xs bg-gradient-to-r from-red-500 to-pink-500 text-white px-2 py-0.5 rounded-full shadow-lg">
            HOT
          </Badge>
        </div>
      </div>
