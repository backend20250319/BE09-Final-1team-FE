...
export default function RealTimeKeywordWidget() {
  ...
  return (
    <div className="glass hover-lift animate-slide-in rounded-xl px-4 py-3 w-[270px]" style={{ "--delay": "0.2s" }}>
      ...
      <div className="space-y-1 relative z-10">
        {keywords.map((item, index) => (
          <div 
            key={item.keyword} 
            className="trending-keyword glass flex items-center justify-between text-sm px-3 py-2 hover:bg-white/30 rounded-lg transition-all duration-200 group cursor-pointer"
