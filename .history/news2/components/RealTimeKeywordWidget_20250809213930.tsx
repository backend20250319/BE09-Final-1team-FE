...
export default function RealTimeKeywordWidget() {
  ...
  return (
    <div className="animate-slide-in rounded-xl px-4 py-3 w-[270px] bg-white/5 backdrop-blur-sm border border-white/10" style={{ "--delay": "0.2s" }}>
      ...
      <div className="space-y-2">
        {keywords.map((item, index) => (
          <div 
            key={item.keyword} 
            className="keyword-glass flex items-center justify-between text-sm px-3 py-2 rounded-lg group cursor-pointer relative z-10"
