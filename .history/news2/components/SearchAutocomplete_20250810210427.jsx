          ...
          {previewResults.length > 0 && (
            <div className="p-3 border-b border-gray-100">
              ...
              <div className="space-y-2">
                   ...
                   <button
                     key={result.newsId}
                     onClick={() => handleSearch(getFieldValue(result, 'title'))}
                   ...
                   >
                     ...
                     <div className="flex items-center gap-2 mt-1">
                       <span className="text-xs text-gray-500">{getFieldValue(result, 'press')}</span>
                       <span className="text-xs text-gray-400">•</span>
                       <span className="text-xs text-gray-500">{formatDate(getFieldValue(result, 'publishedAt'))}</span>
                     </div>
                   </button>
                 ))}
              </div>
