...
export default function RealTimeKeywordWidget() {
  ...
  return (
    <div className="glass hover-lift animate-slide-in rounded-xl px-4 py-3 w-[270px] transition-all duration-300 backdrop-blur-xl bg-white/20 border border-white/30 shadow-2xl">
