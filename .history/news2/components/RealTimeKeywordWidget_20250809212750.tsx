...
export default function RealTimeKeywordWidget() {
  ...
  return (
    <div className="bg-white/80 backdrop-blur-md border border-gray-200 rounded-xl px-4 py-3 w-[270px] shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
      ...
      <div className="space-y-1">
        {keywords.map((item, index) => (
          <div 
            key={item.keyword} 
            className="flex items-center justify-between text-sm px-3 py-2 hover:bg-gray-50 rounded-lg transition-all duration-200 group cursor-pointer"
          >
