      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="flex items-center space-x-4">
            ...
            {/* Desktop Newsletter Mini Form */}
            <div className="hidden lg:flex items-center space-x-2">
              <Input
                type="email"
                placeholder="뉴스레터 구독"
                className="w-48 h-9 text-sm bg-white/10 border-white/20 text-white placeholder-white/50 focus:bg-white/20 focus:border-white/40 transition-all duration-300"
              />
              <Button
                size="sm"
                className="h-9 px-3 bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 text-white text-sm font-medium"
              >
                구독
              </Button>
            </div>
