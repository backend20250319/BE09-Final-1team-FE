...
export default function RealTimeKeywordWidget() {
  ...
  return (
    <div 
      className="glass hover-lift animate-slide-in rounded-xl px-4 py-3 w-[270px] transition-all duration-300"
    ...
    >
      ...
      <div className="space-y-1">
        {keywords.map((item, index) => (
          <div 
            key={item.keyword} 
            className="trending-keyword flex items-center justify-between text-sm px-3 py-2 hover:bg-white/50 rounded-lg transition-all duration-200 group cursor-pointer animate-slide-in"
            style={{ 
