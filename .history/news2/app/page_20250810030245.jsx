      ...
      <div className="max-w-7xl mx-auto px-4 py-10">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-3">
            ...
            <div className="mb-2">
              {/* 카테고리 버튼과 뉴스레터 구독 */}
              <div className="flex flex-col lg:flex-row items-start gap-2 mb-2 h-fit">
                {/* 왼쪽: 카테고리 버튼과 실시간 키워드 */}
                ...
                <div className="lg:w-80 h-fit">
                  <Card className="glass hover-lift animate-slide-in shadow-lg border-0 h-full" style={{ animationDelay: '0.3s' }}>
