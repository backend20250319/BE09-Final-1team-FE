  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50">
      ...
      <div className="max-w-7xl mx-auto px-4 py-10">
          {/* ===== Top Section: Left content + Right sidebar ===== */}
          <div className="grid lg:grid-cols-12 gap-6">
            {/* LEFT: 카테고리 + 특집 */}
            <div className="lg:col-span-8 space-y-6">
              {/* Category Tabs */}
              <div className="flex items-center justify-between">
                <div className="flex-1 overflow-x-auto flex space-x-2 pb-1">
                  {categories.map((category, index) => (
                    <Button
                      ...
                      className={`whitespace-nowrap hover-lift ${isLoaded ? "animate-slide-in" : "opacity-0"}`}
            ...
            {/* RIGHT: 사이드바 (구독 + 키워드 + 사이드 뉴스) */}
            <aside className="lg:col-span-4 space-y-4">
              {/* sticky 사이드바 */}
              <div className="space-y-4 lg:sticky lg:top-28">
                {/* Newsletter Subscription (compact, no mx-auto) */}
                <Card className="glass hover-lift animate-slide-in shadow-lg border-0">
