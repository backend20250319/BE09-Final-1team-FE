...
class NewsService {
  ...
  async getAllNews(options = {}) {
    ...
    try {
      ...
      // 실제 백엔드 API 호출
      const response = await fetch(getApiUrl(`/news?page=${page}&size=${size}`), {
        method: 'GET',
        headers: {
  ...
  async getNewsByCategory(category, options = {}) {
    ...
    try {
      ...
      const response = await fetch(getApiUrl(`/news${categoryParam}page=${page}&size=${size}`), {
        method: 'GET',
        headers: {
          'Content-Type': 'application/json',
        },
  ...
  async getNewsById(id) {
    ...
    try {
      // 백엔드 API 호출
      const item = await safeApiCall(`/news/${id}`, {
        method: 'GET',
        headers: {
          'Content-Type': 'application/json',
        },
  ...
  async searchNews(query, options = {}) {
    ...
    try {
      // 백엔드 API 호출
      const data = await safeApiCall(`/news/search?query=${encodeURIComponent(query)}`, {
        method: 'GET',
        headers: {
          'Content-Type': 'application/json',
        },
  ...
  async incrementViews(id) {
    try {
      // 백엔드 API 호출
      await safeApiCall(`/news/${id}/view`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
  ...
  async toggleLike(id) {
    try {
      ...
      const response = await safeApiCall(`/news/${id}/like`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
  ...
  async getTrendingNews(options = {}) {
    ...
    try {
      // 백엔드 API 호출
      const data = await safeApiCall('/news/trending', {
        method: 'GET',
        headers: {
          'Content-Type': 'application/json',
        },
  ...
  async getLatestNews(options = {}) {
    ...
    try {
      // 백엔드 API 호출
      const data = await safeApiCall('/news/latest', {
        method: 'GET',
        headers: {
          'Content-Type': 'application/json',
        },
