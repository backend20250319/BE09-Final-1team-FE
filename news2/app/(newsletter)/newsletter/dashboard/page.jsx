    ...
    if (role) {
      ...
      if (savedSubscriptions) {
        ...
        setDashboardStats({
          ...
          totalReads: subscriptions.reduce(
            (sum, nl) => sum + (nl.reads || 0),
            0
          ),
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          <div className="flex items-center justify-between mb-4">
            ...
            <Badge className="bg-green-100 text-green-800">활성 구독자</Badge>
          </div>
          <p className="text-gray-600">
            구독 활동과 읽기 패턴을 한눈에 확인하세요
          </p>
        </div>
            ...
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold text-gray-900">
                    {dashboardStats.averageReadTime}분
                  </p>
                </div>
              ...
              <CardContent>
                <div className="space-y-4">
                  {popularContent.map((content, index) => (
                    <div
                      key={index}
                      className="flex items-center justify-between p-3 bg-white/50 rounded-lg hover:bg-white/70 transition-all duration-300"
                    >
              ...
              <CardContent>
                <div className="space-y-3">
                  {recentActivity.map((activity, index) => (
                    <div
                      key={index}
                      className="flex items-center justify-between p-2 rounded-lg hover:bg-white/50 transition-all duration-300"
                    >
              ...
              <CardContent>
                <div className="space-y-3">
                  <Link href="/newsletter">
                    ...
                    >
                      <Mail className="h-4 w-4 mr-2" />새 뉴스레터 구독
                    </Button>
                  </Link>
                  <Button
                    variant="outline"
