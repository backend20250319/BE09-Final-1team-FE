...
export default function AiSummaryModal({
    ...
    const [pos, setPos] = useState({ top: 0, left: 0 });
     ...
     // lines 우선순위: props.lines → data.lines → 3
    ...
    useEffect(() => {
        ...
        // const cx = typeof anchorX === "number" ? anchorX : window.innerWidth / 2;
        // const cy = typeof anchorY === "number" ? anchorY : 120;
    ...
    }, [anchorX, anchorY, offset, preferredWidth]);
